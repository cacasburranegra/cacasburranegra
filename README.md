...
def startroblox(PlaceID: int, JobID: str, Cookie: str):
    ...
    url = urllib.parse.quote(
        ...
        f'https://assetgame.roblox.com/game/PlaceLauncher.ashx?request=RequestGame{"Job"}&browserTrackerId=147062882894&placeId={PlaceID}{"&gameId=" + JobID}&isPlayTogetherGame=false+browsertrackerid:147062882894+robloxLocale:en_us+gameLocale:en_us+channel:+LaunchExp:InApp'
    )
